...
SOURCES = \
	__init__.py \
	create_date.py create_date_dialog.py

PLUGINNAME = create_date

PY_FILES = \
	__init__.py \
	create_date.py create_date_dialog.py

UI_FILES = create_date_dialog_base.ui
...
QGISDIR=C:\Users\mateu\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
